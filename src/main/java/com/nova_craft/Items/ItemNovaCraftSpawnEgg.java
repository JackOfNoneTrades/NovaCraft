...
import com.nova_craft.entity.EntitiesNovaCraft.NovaCraftEggInfo;
...
public class ItemNovaCraftSpawnEgg extends Item {
	...
	public int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_) {
		NovaCraftEggInfo entityegginfo = entityEggs.get(Integer.valueOf(p_82790_1_.getItemDamage()));
	...
	public static Entity spawnCreature(World p_77840_0_, int p_77840_1_, double p_77840_2_, double p_77840_4_, double p_77840_6_) {
		if (!entityEggs.containsKey(Integer.valueOf(p_77840_1_))) {
			...
			for (int j = 0; j < 1; ++j) {
				entity = EntitiesNovaCraft.createEntityByID(p_77840_1_, p_77840_0_);
