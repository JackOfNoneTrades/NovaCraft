...
public class ItemRawEnderAvis extends ItemNovaCraftFood {

	@SideOnly(Side.CLIENT)
	private IIcon alternativeIcon;

	public ItemRawEnderAvis() {
		super(3);

		this.setHasSubtypes(false);
		this.setCreativeTab(NovaCraftCreativeTabs.items);
		this.setTextureName(NovaCraft.find("raw_enderavis"));
	}
	...
	public void registerIcons(IIconRegister registry) {
		...
		this.alternativeIcon = registry.registerIcon(NovaCraft.find("raw_enderavis"));
	}
