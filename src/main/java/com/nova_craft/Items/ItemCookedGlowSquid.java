...
public class ItemCookedGlowSquid extends ItemNovaCraftFood {
	...
	public ItemCookedGlowSquid() {
		...
		this.setTextureName(NovaCraft.find("cooked_glowsquid"));
	}
	...
	public void registerIcons(IIconRegister registry) {
		...
		this.alternativeIcon = registry.registerIcon(NovaCraft.find("cooked_glowsquid"));
	}

	@Override
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
		player.addPotionEffect(new PotionEffect(Potion.nightVision.id, 180, 0));
	}
