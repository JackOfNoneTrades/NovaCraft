...
public class ItemCookedBlazingCharger extends ItemNovaCraftFood {

	@SideOnly(Side.CLIENT)
	private IIcon alternativeIcon;

	public ItemCookedBlazingCharger() {
		super(8);

		this.setHasSubtypes(false);
		this.setCreativeTab(NovaCraftCreativeTabs.items);
		this.setTextureName(NovaCraft.find("cooked_blazing_charger"));
	}
	...
	public void registerIcons(IIconRegister registry) {
		...
		this.alternativeIcon = registry.registerIcon(NovaCraft.find("cooked_blazing_charger"));
	}
