...
public class ItemPotionFireResistanceExtended extends ItemNovaCraftFood {

	public ItemPotionFireResistanceExtended() {
		super(0);
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
		player.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 28800, 0));
	}
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip, final boolean who) {
        tooltip.add(EnumChatFormatting.GRAY + "" + StatCollector.translateToLocal("tooltip.potion.fire.resistance.desc"));
    }
