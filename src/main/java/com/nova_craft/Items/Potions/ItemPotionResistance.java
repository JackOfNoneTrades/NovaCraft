...
public class ItemPotionResistance extends ItemNovaCraftFood {

	public ItemPotionResistance() {
		super(0);
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
		player.addPotionEffect(new PotionEffect(Potion.resistance.id, 38400, 0));
	}
