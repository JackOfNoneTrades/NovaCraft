...
public class ItemCrystallizedVaniteLeggings extends ItemArmor implements ISpecialArmor
{

    public ItemCrystallizedVaniteLeggings() {
        super(NCArmorMaterial.CRYSTALLIZED_VANITE, 0, 2);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.crystallized_vanite_leggings) {
            return "nova_craft:textures/armor/crystallized_vanite_layer_2.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Crystallized Vanite Leggings", new Object[0]);
        return null;
    }
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemCrystallizedVaniteLeggings armorItem = (ItemCrystallizedVaniteLeggings) armor.getItem();
