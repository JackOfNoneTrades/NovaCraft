...
public class ItemTophiniteChestplate extends ItemArmor implements ISpecialArmor
{
    public ItemTophiniteChestplate() {
        super(NCArmorMaterial.TOPHINITE, 0, 1);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.tophinite_chestplate) {
            return "nova_craft:textures/armor/tophinite_layer_1.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Tophinite Chestplate", new Object[0]);
        return null;
    }
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemTophiniteChestplate armorItem = (ItemTophiniteChestplate) armor.getItem();
