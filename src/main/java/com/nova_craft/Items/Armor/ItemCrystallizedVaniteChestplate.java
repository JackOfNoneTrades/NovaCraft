...
public class ItemCrystallizedVaniteChestplate extends ItemArmor implements ISpecialArmor
{

    public ItemCrystallizedVaniteChestplate() {
        super(NCArmorMaterial.CRYSTALLIZED_VANITE, 0, 1);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.crystallized_vanite_chestplate) {
            return "nova_craft:textures/armor/crystallized_vanite_layer_1.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Crystallized Vanite Chestplate", new Object[0]);
        return null;
    }
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemCrystallizedVaniteChestplate armorItem = (ItemCrystallizedVaniteChestplate) armor.getItem();
