...
public class ItemVaniteOrangeCrown extends ItemArmor {

	boolean wearing_ancient_leggings;

	 public ItemVaniteOrangeCrown() {
	        super(NCArmorMaterial.BASE_CROWN, 0, 0);
	        this.setCreativeTab(NovaCraftCreativeTabs.tools);
	    }

	    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
	        if (stack.getItem() == NovaCraftItems.vanite_orange_crown) {
	            return "nova_craft:textures/armor/vanite_crown/vanite_orange_layer_1.png";
	        }
	        FMLLog.log(Level.ERROR, "Invaild Texture for Orange Vanite Crown", new Object[0]);
	        return null;
	    }

	    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip, final boolean who) {
	 	   tooltip.add(EnumChatFormatting.DARK_RED + "" + StatCollector.translateToLocal("tooltip.orange_vanite_crown.desc"));
	 	}
	    ...
	    public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
	        ...
	        if (helmet != null) {
	        	hasCrown = (helmet.getItem() == NovaCraftItems.vanite_orange_crown);
	        }
	        if (legs != null) {
	...
	public Multimap getItemAttributeModifiers() {
        ...
        multimap.put(SharedMonsterAttributes.movementSpeed.getAttributeUnlocalizedName(), new AttributeModifier(field_111210_e, "speed_boost", 0.10D, 2));
        	return multimap;
		}
		else {
			Multimap multimap = HashMultimap.create();
