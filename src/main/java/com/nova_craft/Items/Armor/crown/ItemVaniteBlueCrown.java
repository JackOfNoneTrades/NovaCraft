...
public class ItemVaniteBlueCrown extends ItemArmor {
	...
	boolean wearing_ancient_leggings;
	 ...
	 public ItemVaniteBlueCrown() {
	        super(NCArmorMaterial.BASE_CROWN, 0, 0);
	        this.setCreativeTab(NovaCraftCreativeTabs.tools);
	    }

	    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
	        if (stack.getItem() == NovaCraftItems.vanite_blue_crown) {
	            return "nova_craft:textures/armor/vanite_crown/vanite_blue_layer_1.png";
	        }
	        FMLLog.log(Level.ERROR, "Invaild Texture for Blue Vanite Crown", new Object[0]);
	        return null;
	    }

	    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip, final boolean who) {
	 	   tooltip.add(EnumChatFormatting.BLUE + "" + StatCollector.translateToLocal("tooltip.blue_vanite_crown.desc"));
	 	}
	    ...
	    public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
	        ...
	        if (helmet != null) {
	        	hasCrown = (helmet.getItem() == NovaCraftItems.vanite_blue_crown);
	        }
	        if (legs != null) {
