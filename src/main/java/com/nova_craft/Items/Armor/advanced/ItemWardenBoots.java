...
public class ItemWardenBoots extends ItemArmor implements ISpecialArmor
{
    ...
    public void onUpdate(final World world, final EntityPlayer player, final ItemStack itemStack) {
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemWardenBoots armorItem = (ItemWardenBoots) armor.getItem();
