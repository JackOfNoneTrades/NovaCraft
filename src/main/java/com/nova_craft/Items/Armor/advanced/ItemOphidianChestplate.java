...
public class ItemOphidianChestplate extends ItemArmor implements ISpecialArmor
{
    ...
    public ItemOphidianChestplate() {
        super(NCArmorMaterial.OPHIDIAN, 0, 1);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.ophidian_chestplate) {
            return "nova_craft:textures/armor/ophidian_layer_1.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Ophidian Chestplate", new Object[0]);
        return null;
    }
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemOphidianChestplate armorItem = (ItemOphidianChestplate) armor.getItem();
