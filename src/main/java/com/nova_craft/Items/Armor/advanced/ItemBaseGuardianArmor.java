...
public class ItemBaseGuardianArmor extends ItemArmor {
	...
	private String[] defualt_location = new String[]{"nova_craft:textures/armor/guardian_layer_1.png", "nova_craft:textures/armor/guardian_layer_2.png"};
	...
	public ItemBaseGuardianArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseGuardianArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
