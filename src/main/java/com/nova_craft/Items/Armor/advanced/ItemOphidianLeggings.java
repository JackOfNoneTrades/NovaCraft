...
public class ItemOphidianLeggings extends ItemArmor implements ISpecialArmor
{
    ...
    public ItemOphidianLeggings() {
        super(NCArmorMaterial.OPHIDIAN, 0, 2);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.ophidian_leggings) {
            return "nova_craft:textures/armor/ophidian_layer_2.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Ophidian Leggings", new Object[0]);
        return null;
    }
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemOphidianLeggings armorItem = (ItemOphidianLeggings) armor.getItem();
