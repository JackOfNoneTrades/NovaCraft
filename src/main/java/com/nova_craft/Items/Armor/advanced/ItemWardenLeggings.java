...
public class ItemWardenLeggings extends ItemArmor implements ISpecialArmor
{
    ...
    public ItemWardenLeggings() {
        super(NCArmorMaterial.WARDEN, 0, 2);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.warden_leggings) {
            return "nova_craft:textures/armor/warden_layer_2.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Warden Leggings", new Object[0]);
        return null;
    }
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
    	ItemWardenLeggings armorItem = (ItemWardenLeggings) armor.getItem();
