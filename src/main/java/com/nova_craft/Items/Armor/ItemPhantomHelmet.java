...
public class ItemPhantomHelmet extends ItemArmor
{
    public ItemPhantomHelmet() {
        super(NCArmorMaterial.PHANTOM, 0, 0);
        this.setCreativeTab(NovaCraftCreativeTabs.tools);
    }

    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.phantom_helmet) {
            return "nova_craft:textures/armor/phantom_layer_1.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Phantom Helmet", new Object[0]);
        return null;
    }
