...
public class ItemBaseCrystaliteArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/crystalite_layer_1.png", "nova_craft:textures/armor/crystalite_layer_2.png"};
	...
	public ItemBaseCrystaliteArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseCrystaliteArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
