...
public class ItemPherithiumLeggings extends ItemArmor
{
    ...
    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
        if (stack.getItem() == NovaCraftItems.pherithium_leggings) {
            return "nova_craft:textures/armor/pherithium_layer_2.png";
        }
        FMLLog.log(Level.ERROR, "Invaild Texture for Pherithium Leggings", new Object[0]);
        return null;
    }
