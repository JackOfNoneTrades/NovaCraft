...
public class ItemKylaziteBow extends ItemBow {

	@SideOnly(Side.CLIENT)
	private IIcon[] iconArray;

	public ItemKylaziteBow() {
		super();

		this.maxStackSize = 1;
		this.setMaxDamage(6088);
		this.setFull3D();
		this.setTextureName(NovaCraft.find("kylazite_bow"));
	...
	public IIcon getIcon(ItemStack stack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
		if (usingItem != null && stack.getItem() == NovaCraftItems.kylazite_bow) {
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		this.itemIcon = p_94581_1_.registerIcon(NovaCraft.find("kylazite_bow"));
