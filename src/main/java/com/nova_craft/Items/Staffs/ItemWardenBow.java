...
public class ItemWardenBow extends ItemBow {
	...
	public ItemWardenBow() {
		...
		this.setFull3D();
		this.setTextureName(NovaCraft.find("warden_bow"));
	...
	public IIcon getIcon(ItemStack stack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
		if (usingItem != null && stack.getItem() == NovaCraftItems.warden_bow) {
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		this.itemIcon = p_94581_1_.registerIcon(NovaCraft.find("warden_bow"));
