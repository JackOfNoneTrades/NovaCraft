package com.nova_craft.Items.Buckets;
...
public class ItemBlazliniteBucket extends Item {


	public ItemBlazliniteBucket(Block p_i45331_1_) {
		super();
		maxStackSize = 1;
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else
        {
        	...
        	{
        		p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, NovaCraftBlocks.blazlinite);
        	}
        	else {
        		p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, NovaCraftBlocks.blazlinite_blend);
        	}
