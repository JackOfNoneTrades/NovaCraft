...
public class TileEntityAncientChest extends TileEntity implements IInventory
{
  private ItemStack[] chestContents;
  public boolean adjacentChestChecked;
  public TileEntityAncientChest adjacentChestZNeg;
  public TileEntityAncientChest adjacentChestXPos;
  public TileEntityAncientChest adjacentChestXNeg;
  public TileEntityAncientChest adjacentChestZPosition;
  ...
  public TileEntityAncientChest(final int par1) {
      this.chestContents = new ItemStack[36];
  ...
  public String getInventoryName() {
      return this.hasCustomInventoryName() ? this.customName : "tooltip.ancient_city_chest.desc";
  }
  ...
  private void func_90009_a(final TileEntityAncientChest par1TileEntityChest, final int par2) {
  ...
  public void checkForAdjacentChests() {
      if (!this.adjacentChestChecked) {
          ...
          if (this.func_94044_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
              this.adjacentChestXNeg = (TileEntityAncientChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
          }
          if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
              this.adjacentChestXPos = (TileEntityAncientChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
          }
          if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
              this.adjacentChestZNeg = (TileEntityAncientChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
          }
          if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
              this.adjacentChestZPosition = (TileEntityAncientChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
          }
  ...
  private boolean func_94044_a(final int par1, final int par2, final int par3) {
      ...
      return block instanceof BlockAncientChest && ((BlockAncientChest)block).chestType == this.getChestType();
  }
  ...
  public void updateEntity() {
      ...
      if (!this.worldObj.isRemote && this.numUsingPlayers != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0) {
          ...
          for (final Object aList : list) {
              ...
              if (entityplayer.openContainer instanceof ContainerChest) {
                  ...
                  if (iinventory != this && (!(iinventory instanceof InventoryLargeAncientChest) || !((InventoryLargeAncientChest)iinventory).isPartOfLargeChest(this))) {
                      continue;
                  }
      ...
      if (this.numUsingPlayers > 0 && this.lidAngle == 0.0f && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
          ...
          this.worldObj.playSoundEffect(d1, this.yCoord + 0.5, d2, "nova_craft:chest.open", 0.5f, this.worldObj.rand.nextFloat() * 0.1f + 0.9f);
      }
      if ((this.numUsingPlayers == 0 && this.lidAngle > 0.0f) || (this.numUsingPlayers > 0 && this.lidAngle < 1.0f)) {
          ...
          if (this.lidAngle < f3 && f2 >= f3 && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
              ...
              this.worldObj.playSoundEffect(d2, this.yCoord + 0.5, d3, "nova_craft:chest.close", 0.5f, this.worldObj.rand.nextFloat() * 0.1f + 0.9f);
          }
  ...
  public void closeInventory() {
      if (this.getBlockType() != null && this.getBlockType() instanceof BlockAncientChest) {
          --this.numUsingPlayers;
          this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
          this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
          this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord - 1, this.zCoord, this.getBlockType());
  ...
  public int getChestType() {
      if (this.cachedChestType == -1) {
          if (this.worldObj == null || !(this.getBlockType() instanceof BlockAncientChest)) {
              return 0;
          }
          this.cachedChestType = ((BlockAncientChest)this.getBlockType()).chestType;
      }
