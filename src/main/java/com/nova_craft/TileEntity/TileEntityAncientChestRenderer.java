...
public class TileEntityAncientChestRenderer extends TileEntitySpecialRenderer
{
  ...
  public TileEntityAncientChestRenderer() {
      this.chestModel = new ModelChest();
      this.largeChestModel = new ModelLargeChest();
  }

  public void renderTileEntityChestAt(final TileEntityAncientChest par1TileEntityChest, final double par2, final double par4, final double par6, final float par8) {
      int var9;
      if (!par1TileEntityChest.hasWorldObj()) {
          ...
          if (var9 == 0 && var10 instanceof BlockAncientChest) {
              ((BlockAncientChest)var10).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
              var9 = par1TileEntityChest.getBlockMetadata();
          }
      ...
      if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null) {
          ...
          if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null) {
              ...
              this.bindTexture(TileEntityAncientChestRenderer.TEXTURE_SINGLE);
          }
          else {
              var11 = this.largeChestModel;
              this.bindTexture(TileEntityAncientChestRenderer.TEXTURE_DOUBLE);
          }
          GL11.glPushMatrix();
          GL11.glEnable(32826);
  ...
  public void renderTileEntityAt(final TileEntity par1TileEntity, final double par2, final double par4, final double par6, final float par8) {
      this.renderTileEntityChestAt((TileEntityAncientChest)par1TileEntity, par2, par4, par6, par8);
  }

  static {
      TEXTURE_DOUBLE = new ResourceLocation("nova_craft", "textures/gui/ancient_chest_double.png");
      TEXTURE_SINGLE = new ResourceLocation("nova_craft", "textures/gui/ancient_chest.png");
  }
}
