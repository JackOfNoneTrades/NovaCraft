package com.nova_craft.container;
...
public class LegendaryEnchantmentTableContainer extends Container
{
    ...
    public IInventory tableInventory = new InventoryBasic("Enchant", true, 1)
    {
        ...
        {
            super.markDirty();
            LegendaryEnchantmentTableContainer.this.onCraftMatrixChanged(this);
        }
    };
    ...
    public LegendaryEnchantmentTableContainer(InventoryPlayer p_i1811_1_, World p_i1811_2_, int p_i1811_3_, int p_i1811_4_, int p_i1811_5_)
    {
    ...
    public void updateProgressBar(int p_75137_1_, int p_75137_2_)
    {
        ...
        {
            this.enchantLevels[p_75137_1_] = 90; //p_75137_2_
        }
        else
        {
    ...
    public boolean enchantItem(EntityPlayer p_75140_1_, int p_75140_2_)
    {
        ...
        if (this.enchantLevels[p_75140_2_] > 0 && itemstack != null && (p_75140_1_.experienceLevel >= 90 || p_75140_1_.capabilities.isCreativeMode)) //this.enchantLevels[p_75140_2_]
        {
            if (!this.worldPointer.isRemote)
            {
                ...
                if (list != null)
                {
                    p_75140_1_.addExperienceLevel(-90); //this.enchantLevels[p_75140_2_]
                       ...
                       EnchantmentData enchantmentdata = (EnchantmentData)list.get(k);
                        ...
                        if (!flag || k != j)
                        {
                            ...
                            else
                            {
                                ...
                                p_75140_1_.triggerAchievement(AchievementsNovaCraft.hardcore_enchanter);
                            }
                       }
                    }
    ...
    {
        return this.worldPointer.getBlock(this.posX, this.posY, this.posZ) != NovaCraftBlocks.legendary_enchantment_table ? false : p_75145_1_.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
