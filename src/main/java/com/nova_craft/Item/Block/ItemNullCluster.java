...
public class ItemNullCluster extends ItemBlock {

	private static final String[] item_names = new String[] {"null_bud", "null_medium_bud", "null_large_bud", "null_cluster"};

	public ItemNullCluster(Block p_i45328_1_) {
		super(p_i45328_1_);
		setHasSubtypes(true);
	}
