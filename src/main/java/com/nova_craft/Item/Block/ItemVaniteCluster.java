...
public class ItemVaniteCluster extends ItemBlock {

	private static final String[] item_names = new String[] {"vanite_cluster"};

	public ItemVaniteCluster(Block p_i45328_1_) {
		super(p_i45328_1_);
		setHasSubtypes(true);
	}
