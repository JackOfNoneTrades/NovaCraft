...
public class EntityGlowLichenParticle extends EntityFX
{
    ...
    public EntityGlowLichenParticle(World p_i1222_1_, double p_i1222_2_, double p_i1222_4_, double p_i1222_6_, double p_i1222_8_, double p_i1222_10_, double p_i1222_12_)
    {
        ...
        this.portalParticleScale = this.particleScale = this.rand.nextFloat() * 0.01F + 0.3F;
