package com.nova_craft.particles.entity;
...
public class EntityRandomShapedParticleOld extends EntityFX
{
    ...
    public EntityRandomShapedParticleOld(final World world, final double x, final double y, final double z, final double mx, final double my, final double mz, final int maxAge, final float scale, final int color, final ResourceLocation texture, final int textures) {
    ...
    public void renderParticle(final Tessellator par1Tessellator, final float partialTicks, final float rx, final float rxz, final float rz, final float ryz, final float rxy) {
        final float ipx = (float)(this.prevPosX + (this.posX - this.prevPosX) * partialTicks - EntityRandomShapedParticle.interpPosX);
        final float ipy = (float)(this.prevPosY + (this.posY - this.prevPosY) * partialTicks - EntityRandomShapedParticle.interpPosY);
        final float ipz = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * partialTicks - EntityRandomShapedParticle.interpPosZ);
