...
public class EntityEnderLordParticle extends EntityFX
{
    ...
    public EntityEnderLordParticle(final World world, final double x, final double y, final double z, final double mx, final double my, final double mz, final int maxAge, final float scale, final int color, final ResourceLocation texture, final int textures) {
