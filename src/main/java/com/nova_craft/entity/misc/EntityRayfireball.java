...
public class EntityRayfireball extends EntityProjectileBase {
	...
	public EntityRayfireball(World world, EntityLivingBase thrower, double x, double y, double z) {
		super(world, thrower);
	...
	@Override
	 protected void onImpact(final MovingObjectPosition object) {
		if (object.entityHit instanceof EntityLivingBase) {
			...
			this.worldObj.createExplosion((Entity)null, this.posX, this.posY, this.posZ, 3.5f, false);
