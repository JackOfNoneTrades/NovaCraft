...
public class KlangiteSwordProjectile extends Entity implements IProjectile
{
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (this.shootingEntity == null) {
                    	damagesource = NovaCraftDamageSource.causeKlangiteSwordDamage(this, this);
                    }
                    else {
                    	 damagesource = NovaCraftDamageSource.causeKlangiteSwordDamage(this, this.shootingEntity);
                        this.worldObj.playSoundAtEntity((Entity)this, "nova_craft:null_explosion", 1.0f, 1.2f / (this.rand.nextFloat() * 0.2f + 0.9f));
                        this.setDead();
                    }
