...
public class EntityDiamondFirechargeProjectile extends EntityProjectileBase implements IProjectile
{
    ...
    public EntityDiamondFirechargeProjectile(final World p_i1753_1_) {
        super(p_i1753_1_);
    ...
    public EntityDiamondFirechargeProjectile(final World p_i1754_1_, final double p_i1754_2_, final double p_i1754_4_, final double p_i1754_6_) {
        super(p_i1754_1_);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    public EntityDiamondFirechargeProjectile(final World p_i1755_1_, final EntityLivingBase p_i1755_2_, final EntityLivingBase p_i1755_3_, final float p_i1755_4_, final float p_i1755_5_) {
        super(p_i1755_1_);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    public EntityDiamondFirechargeProjectile(final World p_i1756_1_, final EntityLivingBase p_i1756_2_, final float p_i1756_3_) {
        super(p_i1756_1_);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (this.shootingEntity == null) {
                        damagesource = NovaCraftDamageSource.causeDiamondFirechargeDamage(this, this);
                    }
                    else {
                        damagesource = NovaCraftDamageSource.causeDiamondFirechargeDamage(this, this.shootingEntity);
                    }
            ...
            if (movingobjectposition != null) {
                if (!this.worldObj.isRemote) {
                    if (movingobjectposition.entityHit != null) {
                        if (movingobjectposition.entityHit.attackEntityFrom(NovaCraftDamageSource.causeDiamondFirechargeDamage(this, this.shootingEntity), 1.5f)) {}
                        this.worldObj.createExplosion((Entity)null, this.posX, this.posY, this.posZ, 1.5f, true);
                        this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, 1.5f, true, this.doesArrowBelongToPlayer);
                    }
                    this.worldObj.createExplosion((Entity)null, this.posX, this.posY, this.posZ, 1.5f, true);
                    this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, 1.5f, true, this.doesArrowBelongToPlayer);
                }
