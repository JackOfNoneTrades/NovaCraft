...
public class EntityIceProjectile extends EntityArrow implements IThrowableEntity {
	...
	public EntityIceProjectile(World worldIn, EntityLivingBase shooter, float distance) {
