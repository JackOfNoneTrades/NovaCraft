...
public class EntitySculkLaser extends Entity implements IProjectile
{
    ...
    public EntitySculkLaser(final World par1World, final double par2, final double par3, final double par4) {
        super(par1World);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    public EntitySculkLaser(final World par1World, final EntityLivingBase par2EntityLivingBase) {
        super(par1World);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    public EntitySculkLaser(final World par1World, final EntityLivingBase par2EntityLivingBase, final EntityLivingBase par3EntityLivingBase, final float par4, final float par5) {
        super(par1World);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    public EntitySculkLaser(final World par1World, final EntityLivingBase par2EntityLivingBase, final float par3) {
        super(par1World);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
    ...
    protected void onImpact(MovingObjectPosition p_70227_1_)
    {
        if (!this.worldObj.isRemote)
        {
            if (p_70227_1_.entityHit != null)
            {
                ...
                {
                    p_70227_1_.entityHit.setFire(8);
                }
                this.setDead();
            }
            else
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (entity2.canBeCollidedWith() && !(entity2 instanceof EntitySculkIncinerator) && (entity2 != this.shootingEntity || this.ticksInAir >= 5)) {
                    final float f2 = 0.3f;
