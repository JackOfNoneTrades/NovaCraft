...
public class DeepOneEggRenderer implements ISimpleBlockRenderingHandler
{
    final int renderID;
    private final TileEntityDeepOneEgg egg;

    public DeepOneEggRenderer(final int var1) {
        this.egg = new TileEntityDeepOneEgg();
        this.renderID = var1;
    }
