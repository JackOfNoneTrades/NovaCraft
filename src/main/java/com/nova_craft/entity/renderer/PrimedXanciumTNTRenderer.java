...
public class PrimedXanciumTNTRenderer extends Render
{
    ...
    public void doRender(final Entity p_76986_1_, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        this.doRender((EntityPrimedXanciumTNT)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }

    public void doRender(final EntityPrimedXanciumTNT p_76986_1_, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        GL11.glPushMatrix();
        ...
        this.blockRenderer.renderBlockAsItem(NovaCraftBlocks.xancium_TNT, 0, p_76986_1_.getBrightness(p_76986_9_));
    ...
    protected ResourceLocation getEntityTexture(final Entity p_110775_1_) {
        return this.getEntityTexture((EntityPrimedXanciumTNT)p_110775_1_);
    }

    protected ResourceLocation getEntityTexture(final EntityPrimedXanciumTNT p_110775_1_) {
