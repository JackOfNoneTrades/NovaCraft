...
import com.nova_craft.entity.models.IceologerModel;
...
public class IceologerOverlayRenderer extends IceologerRenderer {
	...
	public ResourceLocation slaughter_texture = new ResourceLocation("nova_craft", "textures/entity/iceologer/iceologer_overlay.png");
	public ModelBiped tutModel;

	public IceologerOverlayRenderer() {
		super();
		this.mainModel = new IceologerModel();
		this.modelBipedMain = (IceologerModel) this.mainModel;
