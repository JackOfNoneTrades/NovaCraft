package com.nova_craft.entity.renderer.hardmode;
...
import com.nova_craft.entity.models.hardmode.HardmodeCreeperModel;

@SideOnly(Side.CLIENT)
public class HardmodeCreeperRenderer extends RenderLiving
{
    private static final ResourceLocation armoredCreeperTextures = new ResourceLocation("nova_craft", "textures/entity/hardmode/hardmode_creeper_armor.png");
    private static final ResourceLocation creeperTextures = new ResourceLocation("nova_craft", "textures/entity/hardmode/hardmode_creeper.png");
    private ModelBase creeperModel = new HardmodeCreeperModel(2.0F);

    public HardmodeCreeperRenderer()
    {
