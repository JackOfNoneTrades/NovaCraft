...
public class BloviatorProjectileRenderer extends Render {

    public BloviatorProjectileRenderer() {
        super();

        this.shadowSize = 0.0F;
    }

    public void doRenderNew(EntityBloviatorProjectile entity, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.doRenderNew((EntityBloviatorProjectile) par1Entity, par2, par4, par6, par8, par9);
    }
