...
public class SculkedMonitorProjectileRenderer extends Render {

    public SculkedMonitorProjectileRenderer() {
        super();

        this.shadowSize = 0.0F;
    }

    public void doRenderProjectileWave(EntitySculkedMonitorProjectile projectile, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.doRenderProjectileWave((EntitySculkedMonitorProjectile) par1Entity, par2, par4, par6, par8, par9);
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity entity) {
        return NovaCraft.locate("textures/items/sculk_flesh.png");
    }
