package com.nova_craft.entity.illager;
...
public class EntityIllagerTrader extends EntityAgeable implements IMerchant, INpc, IRangedAttackMob
{
  ...
  public EntityIllagerTrader(final World p_i1747_1_) {
      this(p_i1747_1_, 0);
  }

  public EntityIllagerTrader(final World p_i1748_1_, final int p_i1748_2_) {
      super(p_i1748_1_);
      ...
      this.tasks.addTask(1, (EntityAIBase)new EntityAITradeIllager(this));
      this.tasks.addTask(1, (EntityAIBase)new EntityAILookAtTradePlayerIllager(this));
      ...
      this.tasks.addTask(6, (EntityAIBase)new EntityAIIllagerTraderMate(this));
  ...
  public void attackEntityWithRangedAttack(final EntityLivingBase p_82196_1_, final float p_82196_2_) {
      ...
      if (i > 0) {
          entityarrow.setDamage(entityarrow.getDamage() + i * 0.8 + 0.8);
      }
      if (j > 0) {
  ...
  public void onUpdate() {
      ...
      if (attacker != null && this.switchCoolDown == 0) {
          ...
          else if (var1 != null && d > 5.0f && !this.isChild() && var1.getItem() != Items.bow) {
              this.switchCoolDown = 200;
      ...
      if (!flag && this.isEntityAlive() && !this.isTrading() && !this.isChild() && this.getAttackTarget() == null && !p_70085_1_.isSneaking()) {
          if (!this.worldObj.isRemote) {
              ...
              if (this.hasCustomNameTag()) {
                  ...
                  p_70085_1_.displayGUIMerchant((IMerchant)this, StatCollector.translateToLocal("entity.nova_craft.vindicator_trader.name"));
                  p_70085_1_.triggerAchievement(AchievementsNovaCraft.what_are_ya_buyin);
              }
          }
          return true;
  ...
  private void addDefaultEquipmentAndRecipies(final int p_70950_1_) {
      ...
      buyItem(merchantrecipelist, NovaCraftItems.eerie_sword, 0, 1, (Item)NovaCraftItems.disc_fragment_5, 0, 1 + this.rand.nextInt(3), this.rand, this.adjustProbability(0.05f));

      buyItem(merchantrecipelist, Item.getItemFromBlock((Block)NovaCraftBlocks.inked_sculk_block), 0, 14 + this.rand.nextInt(15), (Item)NovaCraftItems.sculk_helmet, 0, 1, this.rand, this.adjustProbability(0.05f));

      buyItem(merchantrecipelist, Item.getItemFromBlock((Block)NovaCraftBlocks.inked_sculk_block), 0, 30 + this.rand.nextInt(10), (Item)NovaCraftItems.sculk_chestplate, 0, 1, this.rand, this.adjustProbability(0.05f));

      buyItem(merchantrecipelist, Item.getItemFromBlock((Block)NovaCraftBlocks.inked_sculk_block), 0, 28 + this.rand.nextInt(10), (Item)NovaCraftItems.sculk_leggings, 0, 1, this.rand, this.adjustProbability(0.05f));

      buyItem(merchantrecipelist, Item.getItemFromBlock((Block)NovaCraftBlocks.inked_sculk_block), 0, 14 + this.rand.nextInt(15), (Item)NovaCraftItems.sculk_boots, 0, 1, this.rand, this.adjustProbability(0.05f));

      buyItem(merchantrecipelist, NovaCraftItems.sculk_dweller_heart, 0, 1, (Item)NovaCraftItems.nullwart, 0, 1 + this.rand.nextInt(2), this.rand, this.adjustProbability(0.08f));

      buyItem(merchantrecipelist, Item.getItemFromBlock((Block)Blocks.log), 0, 32 + this.rand.nextInt(14), Item.getItemFromBlock((Block)NovaCraftBlocks.luminant_log), 0, 8 + this.rand.nextInt(8), this.rand, this.adjustProbability(0.2f));

      buyItem(merchantrecipelist, Items.rotten_flesh, 0, 32 + this.rand.nextInt(14), Items.emerald, 0, 3 + this.rand.nextInt(3), this.rand, this.adjustProbability(0.2f));

      buyItem(merchantrecipelist, NovaCraftItems.raw_chevon, 0, 4 + this.rand.nextInt(4), Items.emerald, 0, 1, this.rand, this.adjustProbability(0.3f));

      buyItem(merchantrecipelist, Items.emerald, 0, 1, Items.cooked_chicken, 0, 4 + this.rand.nextInt(4), this.rand, this.adjustProbability(0.3f));

      buyItem(merchantrecipelist, Items.emerald, 0, 1, Items.cooked_fished, 0, 4 + this.rand.nextInt(4), this.rand, this.adjustProbability(0.3f));

      buyItem(merchantrecipelist, NovaCraftItems.flaming_pitcher_petal, 0, 2 + this.rand.nextInt(4), Items.magma_cream, 0, 1 + this.rand.nextInt(1), this.rand, this.adjustProbability(0.1f));

      buyItem(merchantrecipelist, Item.getItemFromBlock((Block)NovaCraftBlocks.block_of_vanite), 0, 13 + this.rand.nextInt(5), (Item)NovaCraftItems.tophinite_gemstone, 0, 1 + this.rand.nextInt(1), this.rand, this.adjustProbability(0.06f));
