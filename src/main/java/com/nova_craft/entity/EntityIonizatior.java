...
public class EntityIonizatior extends EntityMob
{
        ...
        else if (p_70785_2_ < 30.0F)
        {
            ...
            if (this.attackTime == 0)
            {
                ...
                if (this.field_70846_g > 1)
                {
                    ...
                    for (int i = 0; i < 4; ++i)
                    {
                    	EntityIonizatiorProjectile entitysmallfireball = new EntityIonizatiorProjectile(this.worldObj, this, d0 + this.rand.nextGaussian() * (double)f1, d1, d2 + this.rand.nextGaussian() * (double)f1);
                        entitysmallfireball.posY = this.posY + (double)(this.height / 3.0F) + 0.5D;
                        this.worldObj.spawnEntityInWorld(entitysmallfireball);

                        EntityIonizatiorProjectile entitysmallfireball2 = new EntityIonizatiorProjectile(this.worldObj, this, d0 + this.rand.nextGaussian() * (double)f1, d1, d2 + this.rand.nextGaussian() * (double)f1);
    ...
    {
        return NovaCraftItems.ionizatior_rod;
    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        if (p_70628_1_)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                this.dropItem(NovaCraftItems.ionizatior_rod, 1);
            }
        }
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        return (this.worldObj.getBlockLightValue(i, j, k) < 12 && canSpawn);
