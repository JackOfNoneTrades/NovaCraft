package com.nova_craft.entity.models.hardmode;
...
public class HardmodeMagmaCubeModel extends ModelBase
{
    ModelRenderer[] field_78109_a = new ModelRenderer[8];
    ModelRenderer field_78108_b;

    public HardmodeMagmaCubeModel()
    {
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        float f3 = EntityHardmodeMagmaCube.prevSquishFactor + (EntityHardmodeMagmaCube.squishFactor - EntityHardmodeMagmaCube.prevSquishFactor) * p_78086_4_;
