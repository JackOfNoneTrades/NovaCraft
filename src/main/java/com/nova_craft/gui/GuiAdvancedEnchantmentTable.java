...
{
    private static final ResourceLocation field_147078_C = new ResourceLocation("nova_craft","textures/gui/advanced_enchanting_table.png");
    private static final ResourceLocation field_147070_D = new ResourceLocation("nova_craft","textures/entity/advanced_enchanting_table_book.png");
    private static final ModelBook field_147072_E = new ModelBook();
    private Random field_147074_F = new Random();
    private AdvancedEnchantmentTableContainer field_147075_G;
    ...
    public GuiAdvancedEnchantmentTable(InventoryPlayer p_i1090_1_, World p_i1090_2_, int p_i1090_3_, int p_i1090_4_, int p_i1090_5_, String p_i1090_6_)
    {
        super(new AdvancedEnchantmentTableContainer(p_i1090_1_, p_i1090_2_, p_i1090_3_, p_i1090_4_, p_i1090_5_));
        this.field_147075_G = (AdvancedEnchantmentTableContainer)this.inventorySlots;
