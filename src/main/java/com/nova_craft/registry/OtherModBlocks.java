...
public class OtherModBlocks
{
    ...
    static Block getStoneFallback(String modId, String name) {
        Block find = GameRegistry.findBlock(modId, name);
        if (find != null) {
            return find;
        }
        return Blocks.stone;
    ...
    static {
    	OtherModBlocks.deepslate = getStoneFallback("etfuturum", "deepslate");
    	OtherModBlocks.cobbled_deepslate = getStoneFallback("etfuturum", "cobbled_deepslate");
        OtherModBlocks.calcite = getStoneFallback("etfuturum", "calcite");
    	OtherModBlocks.tuff = getStoneFallback("etfuturum", "tuff");
    	OtherModBlocks.dripstone = getStoneFallback("etfuturum", "dripstone");
    	OtherModBlocks.wall_sign_dark_oak = GameRegistry.findBlock("etfuturum", "wall_sign_dark_oak");
    	OtherModBlocks.ancient_debris = getStoneFallback("etfuturum", "ancient_debris");
    	OtherModBlocks.beacon = GameRegistry.findBlock("etfuturum", "beacon");
    	OtherModBlocks.raw_ore_block = getStoneFallback("etfuturum", "raw_ore_block");
