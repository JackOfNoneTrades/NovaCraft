...
public class AncientCitySmallStructure3Gen extends WorldGenerator
{
    ...
    public boolean generate(final World world, final Random random, final int i, final int j, final int k) {
    	PlaceCobbledDeepslate = determineIfCobbledDeepslateExists(world, i + 1, j + 0, k + 1);

    	PlaceDeepslateBricks = determineIfDeepslateBricksExists(world, i + 6, j + 0, k + 1);
    	PlaceCrackedDeepslateBricks = determineIfCrackedDeepslateBricksExists(world, i + 2, j + 0, k + 1);
    	PlaceDeepslateTiles = determineIfDeepslateTilesExist(world, i + 4, j + 0, k + 6);
    	PlaceCrackedDeepslateTiles = determineIfCrackedDeepslateTilesExist(world, i + 3, j + 0, k + 6);
    	PlaceChiseledDeepslate = determineIfChiseledDeepslateExist(world, i + 1, j + 3, k + 9);
		...
		world.setBlock(i + 1, j + 0, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 2, j + 0, k + 1, PlaceCrackedDeepslateBricks, 1, 2);
		world.setBlock(i + 3, j + 0, k + 1, PlaceCrackedDeepslateBricks, 1, 2);
		world.setBlock(i + 4, j + 0, k + 1, PlaceCrackedDeepslateBricks, 1, 2);
		world.setBlock(i + 5, j + 0, k + 1, Blocks.air, 0, 2);
		world.setBlock(i + 6, j + 0, k + 1, PlaceDeepslateBricks, 0, 2);
		world.setBlock(i + 7, j + 0, k + 1, PlaceDeepslateBricks, 0, 2);
		world.setBlock(i + 8, j + 0, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 9, j + 0, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 10, j + 0, k + 1, NovaCraftBlocks.sculk_vein, 5, 2);
		world.setBlock(i + 11, j + 0, k + 1, Blocks.air, 0, 2);
		world.setBlock(i + 0, j + 0, k + 2, PlaceCrackedDeepslateBricks, 1, 2);
		...
		world.setBlock(i + 0, j + 0, k + 4, PlaceDeepslateBricks, 0, 2);
		...
		world.setBlock(i + 0, j + 0, k + 5, PlaceCrackedDeepslateBricks, 1, 2);
		...
		world.setBlock(i + 0, j + 0, k + 6, PlaceCrackedDeepslateBricks, 1, 2);
		world.setBlock(i + 1, j + 0, k + 6, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 2, j + 0, k + 6, Blocks.air, 0, 2);
		world.setBlock(i + 3, j + 0, k + 6, PlaceCrackedDeepslateTiles, 3, 2);
		...
		world.setBlock(i + 0, j + 0, k + 7, PlaceDeepslateBricks, 0, 2);
		...
		world.setBlock(i + 0, j + 0, k + 9, PlaceDeepslateBricks, 0, 2);
		world.setBlock(i + 1, j + 0, k + 9, PlaceCrackedDeepslateBricks, 1, 2);
		world.setBlock(i + 2, j + 0, k + 9, PlaceCrackedDeepslateBricks, 1, 2);
		...
		world.setBlock(i + 1, j + 0, k + 10, PlaceDeepslateBricks, 0, 2);
		...
		world.setBlock(i + 0, j + 1, k + 2, PlaceDeepslateBricks, 0, 2);
		world.setBlock(i + 1, j + 1, k + 2, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 2, j + 1, k + 2, PlaceCrackedDeepslateBricks, 1, 2);
		...
		world.setBlock(i + 1, j + 1, k + 3, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 1, j + 1, k + 5, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 1, j + 1, k + 7, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 2, j + 1, k + 8, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 8, j + 1, k + 8, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 1, j + 1, k + 10, PlaceCrackedDeepslateTiles, 3, 2);
		...
		world.setBlock(i + 2, j + 2, k + 1, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 6, j + 2, k + 1, PlaceDeepslateTiles, 2, 2);
		world.setBlock(i + 7, j + 2, k + 1, NovaCraftBlocks.sculk_vein, 2, 2);
		world.setBlock(i + 8, j + 2, k + 1, PlaceCrackedDeepslateTiles, 3, 2);
		...
		world.setBlock(i + 1, j + 2, k + 8, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 2, j + 2, k + 8, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 2, j + 2, k + 9, PlaceDeepslateTiles, 2, 2);
		...
		world.setBlock(i + 9, j + 2, k + 10, PlaceCrackedDeepslateTiles, 3, 2);
		...
		world.setBlock(i + 3, j + 3, k + 1, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 8, j + 3, k + 1, PlaceDeepslateTiles, 2, 2);
		...
		world.setBlock(i + 2, j + 3, k + 8, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 8, j + 3, k + 8, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 9, j + 3, k + 8, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 10, j + 3, k + 8, NovaCraftBlocks.sculk_vein, 2, 2);
		world.setBlock(i + 11, j + 3, k + 8, Blocks.air, 0, 2);
		world.setBlock(i + 0, j + 3, k + 9, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 1, j + 3, k + 9, PlaceChiseledDeepslate, 4, 2);
		world.setBlock(i + 2, j + 3, k + 9, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 10, j + 3, k + 9, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 11, j + 3, k + 9, NovaCraftBlocks.sculk_vein, 5, 2);
		world.setBlock(i + 0, j + 3, k + 10, Blocks.air, 0, 2);
		world.setBlock(i + 1, j + 3, k + 10, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 4, j + 4, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 5, j + 4, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 6, j + 4, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 7, j + 4, k + 1, PlaceCrackedDeepslateTiles, 3, 2);
		world.setBlock(i + 8, j + 4, k + 1, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 9, j + 4, k + 10, PlaceChiseledDeepslate, 4, 2);
		...
		world.setBlock(i + 5, j + 5, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 6, j + 5, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 7, j + 5, k + 1, PlaceCobbledDeepslate, 0, 2);
		world.setBlock(i + 8, j + 5, k + 1, PlaceCobbledDeepslate, 0, 2);
		...
		world.setBlock(i + 9, j + 5, k + 10, PlaceCrackedDeepslateBricks, 1, 2);
		...
		TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.getTileEntity(i + 8, j + 2, k + 5);
		...
		TileEntityChest chest = (TileEntityChest) world.getTileEntity(i + 5, j + 1, k + 3);
