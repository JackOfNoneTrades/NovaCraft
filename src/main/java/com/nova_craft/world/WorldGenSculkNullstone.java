...
public class WorldGenSculkNullstone extends WorldGenerator
{
    private Block field_150552_a;
    private int field_150551_b;
    //private static final String __OBFID = "CL_00000410";

    public WorldGenSculkNullstone(Block p_i45452_1_)
    {
    ...
    public WorldGenSculkNullstone(Block block, int size)
    {
        this.Sculk = block;
    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
        for (int l = 0; l < this.GroupSize; ++l)
        {
            ...
            if (world.isAirBlock(i1, j1, k1) && (world.getBlock(i1, j1 -1, k1) == NovaCraftBlocks.nullstone) && world.getBlock(i1, j1 -1, k1).isSideSolid(world, x, y-1, z, ForgeDirection.getOrientation(0))) {
