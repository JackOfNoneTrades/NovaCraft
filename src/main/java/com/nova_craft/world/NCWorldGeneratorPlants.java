...
import com.nova_craft.world.structure.AetherGeoGen;
import com.nova_craft.world.structure.CopartzGeoGen;
import com.nova_craft.world.structure.LarimarGeoGen;
import com.nova_craft.world.structure.NovaCraftAdvancedTraditionalDungeonGen;
import com.nova_craft.world.structure.NovaCraftDungeonGen;
import com.nova_craft.world.structure.NovaCraftTraditionalDungeonGen;
import com.nova_craft.world.structure.SculkGeoDungeon;
import com.nova_craft.world.structure.SculkGeoDungeon2;
import com.nova_craft.world.structure.SeaSerpentSpawner;
import com.nova_craft.world.structure.TsavorokiteGeoGen;
...
public class NCWorldGeneratorPlants implements IWorldGenerator {
	...
	public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		if((world.getWorldInfo().getTerrainType() != WorldType.FLAT || world.getWorldInfo().getGeneratorOptions().contains("decoration")) && (ArrayUtils.contains(Configs.WorldGenDimensionBlacklist, world.provider.dimensionId) == Configs.WorldGenDimensionBlacklistAsWhitelist)) {
			...
			int x7;
			int z7;
			x7 = chunkX * 16 + rand.nextInt(16) + 8;
			z7 = chunkZ * 16 + rand.nextInt(16) + 8;
			...
			int x13;
			int z13;
			x13 = chunkX * 16 + rand.nextInt(16) + 8;
			...
			int x14;
			int z14;
			x14 = chunkX * 16 + rand.nextInt(64) + 8;
			z14 = chunkZ * 16 + rand.nextInt(64) + 8;
			if(rand.nextInt(256) == 0) {
			...
			int x8;
			int z8;
			x8 = chunkX * 16 + rand.nextInt(16) + 8;
			z8 = chunkZ * 16 + rand.nextInt(16) + 8;
			...
			int x9;
			int z9;
			x9 = chunkX * 16 + rand.nextInt(16) + 8;
			z9 = chunkZ * 16 + rand.nextInt(16) + 8;
			...
			int x10;
			int z10;
			x10 = chunkX * 16 + rand.nextInt(16) + 8;
			z10 = chunkZ * 16 + rand.nextInt(16) + 8;
			...
			int x12;
			int z12;
			x12 = chunkX * 16 + rand.nextInt(16) + 8;
			...
			int x20;
			int z20;
			x20 = chunkX * 16 + rand.nextInt(16) + 8;
			z20 = chunkZ * 16 + rand.nextInt(16) + 8;
			...
			int x16;
			int z16;
			x16 = chunkX * 16 + rand.nextInt(16) + 8;
			z16 = chunkZ * 16 + rand.nextInt(16) + 8;
			BiomeGenBase biome9;
			Type[] biomeList9;
			biome9 = world.getBiomeGenForCoords(x16, z16);
			biomeList9 = BiomeDictionary.getTypesForBiome(biome9);
			if(BiomeDictionary.isBiomeOfType(biome9, BiomeDictionary.Type.FOREST) && rand.nextInt(5) == 1) {
				int posX = x16 + rand.nextInt(16);
				int posZ = z16 + rand.nextInt(16);
			...
			if((world.getHeightValue(x1, z1) > 0) && BiomeDictionary.isBiomeOfType(biome9, BiomeDictionary.Type.MOUNTAIN)) {
			...
			if (ArrayUtils.contains(Configs.DeeperCavesBlacklist, world.provider.dimensionId) == Configs.DeeperCavesBlacklistAsWhitelist && rand.nextInt(4) == 3) {
