...
public class WorldGenAdditonalCoal extends WorldGenerator
{
    private Block field_150552_a;
    private int field_150551_b;
    //private static final String __OBFID = "CL_00000410";

    public WorldGenAdditonalCoal(Block p_i45452_1_)
    {
    ...
    public WorldGenAdditonalCoal(Block block, int size)
    {
        this.Ore = block;
