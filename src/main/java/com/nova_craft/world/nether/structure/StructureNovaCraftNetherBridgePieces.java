    ...
    public static class Corridor3 extends StructureNovaCraftNetherBridgePieces.Piece
        {
            ...
            public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                int i = this.getMetadataWithOffset(NovaCraftBlocks.nullwart_brick_stairs, 0); //2
                ...
                for (int j = 0; j <= 9; ++j)
                {
                    ...
                    {
                    	{
                    	if (Loader.isModLoaded("etfuturum")) { //stairs here normally
    ...
    public static class NetherStalkRoom extends StructureNovaCraftNetherBridgePieces.Piece
        {
            ...
            public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                i = this.getMetadataWithOffset(NovaCraftBlocks.nullwart_brick_stairs, 0); //good
                int j;
                int k;
                int l;
                ...
                for (j = 5; j <= 7; ++j)
                {
                	{
                		if (Loader.isModLoaded("etfuturum")) { //stairs here normally
                			this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick, i, j, 12, 11, p_74875_3_); //good
                		}
                		else {
                ...
                {
                if (Loader.isModLoaded("etfuturum")) {
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, k, 4, 5, 2, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, k, 4, 5, 3, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, k, 4, 5, 9, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, k, 4, 5, 10, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, j, 8, 5, 2, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, j, 8, 5, 3, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, j, 8, 5, 9, p_74875_3_); //good
                	this.placeBlockAtCurrentPosition(p_74875_1_, OtherModBlocks.red_netherbrick_slab, j, 8, 5, 10, p_74875_3_); //good
                }
                else {
    ...
    public static class Throne extends StructureNovaCraftNetherBridgePieces.Piece
        {
            ...
            public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                if (Loader.isModLoaded("etfuturum")) {
                	...
                	//this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 6, 3, 0, 7, 8,OtherModBlocks.red_nether_brick_wall,OtherModBlocks.red_nether_brick_wall, false);
                	//this.fillWithBlocks(p_74875_1_, p_74875_3_, 6, 6, 3, 6, 7, 8,OtherModBlocks.red_nether_brick_wall,OtherModBlocks.red_nether_brick_wall, false);
                	//this.fillWithBlocks(p_74875_1_, p_74875_3_, 1, 6, 8, 5, 8, 8,OtherModBlocks.red_nether_brick_wall,OtherModBlocks.red_nether_brick_wall, false);
                	//this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 8, 8, 4, 9, 8,OtherModBlocks.red_nether_brick_wall,OtherModBlocks.red_nether_brick_wall, false);
                }
                else {
