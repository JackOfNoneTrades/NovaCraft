...
public class WorldGenSculkBush extends WorldGenerator
{
    ...
    public WorldGenSculkBush(Block block, int size)
    {
        this.Sculk = block;
    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
    	for (int l = 0; l < this.GroupSize; ++l)
        {
            ...
            if (world.isAirBlock(i1, j1, k1) && (world.getBlock(i1, j1 -1, k1) == NovaCraftBlocks.sculk_block) && world.getBlock(i1, j1 -1, k1).isSideSolid(world, i1, j1-1, k1, ForgeDirection.getOrientation(1))) {
