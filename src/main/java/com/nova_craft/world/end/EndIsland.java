...
public class EndIsland extends WorldGenerator {
   int bumpsWide1;
   int bumpsLong1;
   ...
   private Block materialAtLevel(Random rand, int i, boolean flag) {
      ...
      if (i == j) {
          ...
          if (rand3 == 1 ) {
        	  ...
        	  return rand.nextInt(10) == 0 ? Blocks.end_stone : Blocks.end_stone;
        }
      else {
         return (Block)(flag ? Blocks.end_stone : Blocks.end_stone);
      }
   }
         ...
         if (world.getBlock(x1, y1, z1).isReplaceableOreGen(world, x, y, z, Blocks.end_stone)) {
            ...
            for(int yTest = y1; yTest < 128; ++yTest) { //128
               if (world.getBlock(x1, yTest, z1).isReplaceable(world, x1, yTest, z1) && (world.getBlock(x1, yTest - 1, z1) == Blocks.end_stone || world.getBlock(x1, yTest - 1, z1) == Blocks.end_stone)) {
                  world.setBlock(x1, yTest, z1, NovaCraftBlocks.chorus_grass);
                  break;
               }
            }
         }
   ...
   private void generateTallGrass(World world, Random rand, int x, int y, int z) {
      for(int i1 = 0; i1 < 16; ++i1) {
        ...
        int rand2 = (int)(1 + Math.random() * 2);
     	switch (rand2)
        {
        case 1: (new WorldGenTallGrass(NovaCraftBlocks.chorus_grass, 1)).generate(world, rand, j1, l1, k1);
        break;
        case 2: (new WorldGenTallGrass(NovaCraftBlocks.void_sprout, 1)).generate(world, rand, j1, l1, k1);
        break;
        }
