...
public class BlockXanciumTNT extends Block
{
    ...
    public void func_150114_a(final World world, final int x, final int y, final int z, final int p_150114_5_, final EntityLivingBase entityBase) {
        if (!world.isRemote && (p_150114_5_ & 0x1) == 0x1) {
            final EntityPrimedXanciumTNT entitytntprimed = new EntityPrimedXanciumTNT(world, x + 0.5f, y + 0.5f, z + 0.5f, entityBase);
    ...
    public void onBlockDestroyedByExplosion(final World world, final int x, final int y, final int z, final Explosion explosion) {
        if (!world.isRemote) {
            final EntityPrimedXanciumTNT entitytntprimed = new EntityPrimedXanciumTNT(world, x + 0.5f, y + 0.5f, z + 0.5f, explosion.getExplosivePlacedBy());
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:XTNT_side");
		iconFace = iconRegister.registerIcon("nova_craft:XTNT_bottom");
		iconTop = iconRegister.registerIcon("nova_craft:XTNT_top");
	}
}
