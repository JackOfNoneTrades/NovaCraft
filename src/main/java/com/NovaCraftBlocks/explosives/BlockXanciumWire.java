...
public class BlockXanciumWire extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public BlockXanciumWire() {
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:xancium_dust_cross");
		iconFace = iconRegister.registerIcon("nova_craft:xancium_dust_cross");
		iconTop = iconRegister.registerIcon("nova_craft:xancium_dust_cross");
	}
