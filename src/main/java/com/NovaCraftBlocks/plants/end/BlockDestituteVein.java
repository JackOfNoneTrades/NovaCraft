...
public class BlockDestituteVein extends BlockBush
{
	private static final String[] types;
    private IIcon[] icon;

    public BlockDestituteVein() {
    ...
    {
        return (p_149854_1_ == NovaCraftBlocks.destitude_block || p_149854_1_ == NovaCraftBlocks.destitude_growth);
    }


    public void registerBlockIcons(final IIconRegister iconRegister) {
        this.icon[0] = iconRegister.registerIcon("nova_craft:destitute_vein");
        this.icon[1] = iconRegister.registerIcon("nova_craft:destitute_vein");
    }
	...
	public void getSubBlocks(final Item block, final CreativeTabs creativeTabs, final List list) {
        for (int i = 0; i < BlockDestituteVein.types.length; ++i) {
