...
public class BlockArcticMoss extends Block implements IGrowable {
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:arctic_moss_block");
		...
		while (l < 128) {
			...
			while (true) {
				if (l1 < l / 16) {
					...
					if (p_149853_1_.getBlock(i1, j1 - 1, k1) == NovaCraftBlocks.arctic_moss_block && !p_149853_1_.getBlock(i1, j1, k1).isNormalCube()) {
						++l1;
						continue;
					}
				} else if (p_149853_1_.isAirBlock(i1, j1, k1)) {
					if (p_149853_2_.nextInt(3) != 0) {
						if (NovaCraftBlocks.arctic_moss_carpet.canBlockStay(p_149853_1_, i1, j1, k1)) {
							p_149853_1_.setBlock(i1, j1, k1, NovaCraftBlocks.arctic_moss_carpet, 1, 3);
						}
