...
public class BlockSculkGrimstone extends Block implements IGrowable {

	@SideOnly(Side.CLIENT)
	private IIcon blockIconTop;

	public BlockSculkGrimstone() {
		super(Material.grass);

		this.setHardness(2.45F);
		this.setResistance(2.45F);
	...
	public void registerBlockIcons(IIconRegister registry) {
		this.blockIcon = registry.registerIcon("nova_craft:sculk_grimstone");
	...
	public IIcon getIcon(int side, int meta) {
		return side == 1 ? this.blockIconTop : (side == 0 ? NovaCraftBlocks.grimstone.getBlockTextureFromSide(side) : this.blockIcon);
	}
