...
public class BlockAetherCluster extends BlockAether implements ISubBlocksBlock {
	...
	public BlockAetherCluster(int type) {
		super(Material.glass);
		setHardness(3.5F);
		setResistance(3.5F);
		this.setStepSound(ModSounds.soundCrystalCluster);
		setBlockName(Utils.getUnlocalisedName("aether_cluster" + (type + 1)));
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if (entity instanceof EntityPlayer) {
			...
			((EntityLivingBase) entity).addPotionEffect(new PotionEffect(10, 260, 0));
   ...
   public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
   {
    ...
    {
    	if(this == NovaCraftBlocks.aether_cluster_2 && meta >= 6) {
