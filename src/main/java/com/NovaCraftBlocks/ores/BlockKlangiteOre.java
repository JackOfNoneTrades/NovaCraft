...
public class BlockKlangiteOre extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public BlockKlangiteOre() {
		super(Material.iron);
		this.setHardness(40);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:klangite_ore");
		iconFace = iconRegister.registerIcon("nova_craft:klangite_ore");
		iconTop = iconRegister.registerIcon("nova_craft:klangite_ore");
	}
