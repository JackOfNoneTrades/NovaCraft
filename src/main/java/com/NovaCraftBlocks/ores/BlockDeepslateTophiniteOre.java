...
public class BlockDeepslateTophiniteOre extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public BlockDeepslateTophiniteOre() {
		super(Material.iron);
		this.setHardness(20);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:deepslate_tophinite_ore");
		iconFace = iconRegister.registerIcon("nova_craft:deepslate_tophinite_ore");
		iconTop = iconRegister.registerIcon("nova_craft:deepslate_tophinite_ore");
	}
