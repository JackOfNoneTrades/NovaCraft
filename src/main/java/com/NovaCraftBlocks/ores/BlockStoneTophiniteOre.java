...
public class BlockStoneTophiniteOre extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public BlockStoneTophiniteOre() {
		super(Material.iron);
		this.setHardness(30);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:stone_tophinite_ore");
		iconFace = iconRegister.registerIcon("nova_craft:stone_tophinite_ore");
		iconTop = iconRegister.registerIcon("nova_craft:stone_tophinite_ore");
	}
