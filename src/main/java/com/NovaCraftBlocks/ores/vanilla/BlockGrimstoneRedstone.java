...
public class BlockGrimstoneRedstone extends Block
{
    ...
    private void func_150185_e(World p_150185_1_, int p_150185_2_, int p_150185_3_, int p_150185_4_)
    {
        ...
        if (this == NovaCraftBlocks.grimstone_redstone)
        {
            p_150185_1_.setBlock(p_150185_2_, p_150185_3_, p_150185_4_,NovaCraftBlocks.lit_grimstone_redstone);
        }
    }
    ...
    {
        if (this == NovaCraftBlocks.lit_grimstone_redstone)
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, NovaCraftBlocks.grimstone_redstone);
        }
    }
    ...
    {
        return new ItemStack(NovaCraftBlocks.grimstone_redstone);
    }
}
