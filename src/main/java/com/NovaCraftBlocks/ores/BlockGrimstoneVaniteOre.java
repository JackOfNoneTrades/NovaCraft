...
public class BlockGrimstoneVaniteOre extends Block {
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:grimstone_vanite_ore");
		iconFace = iconRegister.registerIcon("nova_craft:grimstone_vanite_ore");
		iconTop = iconRegister.registerIcon("nova_craft:grimstone_vanite_ore");
	}
