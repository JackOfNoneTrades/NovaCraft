...
public class BlockDeepslateVaniteOre extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public BlockDeepslateVaniteOre() {
		super(Material.rock);
		this.setHardness(4);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:deepslate_vanite_ore");
		iconFace = iconRegister.registerIcon("nova_craft:deepslate_vanite_ore");
		iconTop = iconRegister.registerIcon("nova_craft:deepslate_vanite_ore");
	}
