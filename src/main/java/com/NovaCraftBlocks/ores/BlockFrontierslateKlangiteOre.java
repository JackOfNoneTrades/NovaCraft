...
public class BlockFrontierslateKlangiteOre extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public BlockFrontierslateKlangiteOre() {
		super(Material.iron);
		this.setHardness(50);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:frontierslate_klangite_ore");
		iconFace = iconRegister.registerIcon("nova_craft:frontierslate_klangite_ore");
		iconTop = iconRegister.registerIcon("nova_craft:frontierslate_klangite_ore");
	}
