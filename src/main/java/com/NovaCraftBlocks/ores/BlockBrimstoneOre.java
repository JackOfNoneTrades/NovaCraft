...
public class BlockBrimstoneOre extends Block {
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:brimstone_ore");
		iconFace = iconRegister.registerIcon("nova_craft:brimstone_ore");
		iconTop = iconRegister.registerIcon("nova_craft:brimstone_ore");
	}
