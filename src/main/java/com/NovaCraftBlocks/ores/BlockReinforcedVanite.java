...
public class BlockReinforcedVanite extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon iconFace, iconTop;

	public static IIcon InfusedVanite;

	public BlockReinforcedVanite() {
		super(Material.iron);
		this.setHardness(15);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("nova_craft:block_of_reinforced_vanite");
		iconFace = iconRegister.registerIcon("nova_craft:block_of_reinforced_vanite");
		iconTop = iconRegister.registerIcon("nova_craft:block_of_reinforced_vanite");

		BlockReinforcedVanite.InfusedVanite = iconRegister.registerIcon("nova_craft:block_of_reinforced_vanite");
	}
	...
	public void updateTick(World world, int i, int j, int k, Random random) {
		...
		//Dark Essence Structure
		if (world.provider.dimensionId == 1) {
 			if (world.getBlock(i, j - 1, k) == NovaCraftBlocks.nullstone_bricks
                && world.getBlock(i, j - 1, k + 2) == NovaCraftBlocks.nullstone_bricks
                && world.getBlock(i, j - 1, k - 2) == NovaCraftBlocks.nullstone_bricks
                && world.getBlock(i + 2, j - 1, k) == NovaCraftBlocks.nullstone_bricks
                && world.getBlock(i - 2, j - 1, k) == NovaCraftBlocks.nullstone_bricks

                && world.getBlock(i, j, k + 2) == NovaCraftBlocks.variegated_block
                && world.getBlock(i, j, k - 2) == NovaCraftBlocks.variegated_block
                && world.getBlock(i + 2, j, k) == NovaCraftBlocks.variegated_block
                && world.getBlock(i - 2, j, k) == NovaCraftBlocks.variegated_block

                && world.getBlock(i - 2, j - 1, k - 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i - 2, j - 1, k + 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i + 2, j - 1, k - 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i + 2, j - 1, k + 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i - 2, j, k - 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i - 2, j, k + 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i + 2, j, k - 2) == NovaCraftBlocks.frontierslate_bricks
                && world.getBlock(i + 2, j, k + 2) == NovaCraftBlocks.frontierslate_bricks

                && world.getBlock(i - 2, j + 1, k - 2) == NovaCraftBlocks.echo_block
                && world.getBlock(i - 2, j + 1, k + 2) == NovaCraftBlocks.echo_block
                && world.getBlock(i + 2, j + 1, k - 2) == NovaCraftBlocks.echo_block
                && world.getBlock(i + 2, j + 1, k + 2) == NovaCraftBlocks.echo_block
                && world.getBlock(i - 2, j + 2, k - 2) == NovaCraftBlocks.echo_cluster_2
                && world.getBlock(i - 2, j + 2, k + 2) == NovaCraftBlocks.echo_cluster_2
                && world.getBlock(i + 2, j + 2, k - 2) == NovaCraftBlocks.echo_cluster_2
                && world.getBlock(i + 2, j + 2, k + 2) == NovaCraftBlocks.echo_cluster_2

                && world.getBlock(i, j - 1, k + 3) == NovaCraftBlocks.null_wart
                && world.getBlock(i + 1, j - 1, k + 3) == NovaCraftBlocks.null_wart
                && world.getBlock(i - 1, j - 1, k + 3) == NovaCraftBlocks.null_wart
                && world.getBlock(i + 2, j - 1, k + 3) == NovaCraftBlocks.null_wart
                && world.getBlock(i - 2, j - 1, k + 3) == NovaCraftBlocks.null_wart
                && world.getBlock(i + 3, j - 1, k + 3) == NovaCraftBlocks.null_wart
                && world.getBlock(i - 3, j - 1, k + 3) == NovaCraftBlocks.null_wart

                && world.getBlock(i - 3, j - 1, k) == NovaCraftBlocks.null_wart
                && world.getBlock(i - 3, j - 1, k + 1) == NovaCraftBlocks.null_wart
                && world.getBlock(i - 3, j - 1, k - 1) == NovaCraftBlocks.null_wart
